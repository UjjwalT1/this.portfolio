...
btn.forEach(e=>{
    e.addEventListener("click",()=>{
        ...
        if(str=="C++"){
            ...
            target.innerHTML='<span style="color: aliceblue; font-size: 1.7em;">'+str+'</span> <div style="background-color: aliceblue; width: 100%; height: 3px; margin: 3px 0 50px 0;"></div>'
        }
    })
...
cert.forEach(e=>{
    e.addEventListener("click",()=>{
        ...
        target.parentElement.classList.add("act")
        if(str=="CSS"){
            target.innerHTML='<img src="photo/SAMPLE.jpg">'
        }
        else if(str=="JavaScript"){
            target.innerHTML='<img src="photo/SAMPLE.jpg">'
        }
